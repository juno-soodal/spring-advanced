...
class CommentServiceTest {
    ...
    public void comment_등록_중_할일을_찾지_못해_에러가_발생한다() {
        ...
        given(todoFinder.find(anyLong())).willThrow(new InvalidRequestException("Todo not found"));
    ...
    public void comment를_정상적으로_등록한다() {
        ...
        given(todoFinder.find(anyLong())).willReturn(todo);
        doNothing().when(commentWriter).create(any(Comment.class));
    // when
